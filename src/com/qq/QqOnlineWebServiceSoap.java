...
public interface QqOnlineWebServiceSoap {
    ...
    @RequestWrapper(localName = "qqCheckOnline", targetNamespace = "http://WebXml.com.cn/", className = "com.qq.QqCheckOnline")
    @WebMethod(action = "http://WebXml.com.cn/qqCheckOnline")
    @ResponseWrapper(localName = "qqCheckOnlineResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.qq.QqCheckOnlineResponse")
