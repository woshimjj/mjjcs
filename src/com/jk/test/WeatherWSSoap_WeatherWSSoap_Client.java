...
public final class WeatherWSSoap_WeatherWSSoap_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {
        ...
        com.jk.test.GetSupportCityDatasetResponse.GetSupportCityDatasetResult _getSupportCityDataset__return = port.getSupportCityDataset(_getSupportCityDataset_theRegionCode);
        ...
        com.jk.test.ArrayOfString _getWeather__return = port.getWeather(_getWeather_theCityCode, _getWeather_theUserID);
        ...
        com.jk.test.ArrayOfString _getSupportCityString__return = port.getSupportCityString(_getSupportCityString_theRegionCode);
        ...
        com.jk.test.ArrayOfString _getRegionProvince__return = port.getRegionProvince();
        ...
        com.jk.test.ArrayOfString _getRegionCountry__return = port.getRegionCountry();
        ...
        com.jk.test.GetRegionDatasetResponse.GetRegionDatasetResult _getRegionDataset__return = port.getRegionDataset();
